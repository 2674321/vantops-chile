...
import { getDefaultChecklist, getVisibleChecklistItems, getContextFromData, getChecklistProgress, getItemsByCategory, toggleItem, resetChecklist } from "../../domain/checklist/engine";
...
export function ChecklistCard({ weather, solar, assessment }: ChecklistCardProps) {
  ...
  const allItems = useMemo(() => {
    ...
    return getVisibleChecklistItems(base, context);
  }, [context]);
